...
@section('content')
    <br>
    <a href="/data_dosen/add" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add Data</a><br>
                                    ...
                                    <tbody>
                                        @foreach ($dbdosen as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->semester }}</td>
                                                <td><img src="{{ url('foto_dosen/' . $data->foto_dosen) }}" width="120px">
                                                </td>
                                                <td>{{ $data->status }}</td>
                                                <td>
                                                    <a href="/data_dosen/edit/{{ $data->id }}"
