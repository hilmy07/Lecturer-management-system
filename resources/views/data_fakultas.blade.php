...
@section('content')
<a href="/data_fakultas/add" class="btn btn-primary btn-sm">Add Data</a><br>
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <td><a href="/data_fakultas/edit{{ $data->id }}" class="btn btn-sm btn-warning">Edit</a></td>
                ...
                <div class="modal-dialog modal-sm">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="/data_fakultas/delete/{{ $item->id}}" class="btn btn-outline">Yes</a>
                    </div>
                  </div>
                    <!-- /.modal-content -->
                </div>
