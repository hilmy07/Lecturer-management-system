        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <!-- <label><strong>Mata Kuliah</strong></label><br>  -->
                    ...
                    <!-- <select class="form-control select2" name="mata_kuliah[]" multiple="multiple" data-placeholder="Pilih matkul"
                            style="width: 100%;">
                    <option>pendidikan_agama</option>
                    <option>bahasa_indonesia</option>
                    <option>Bahasa Inggris</option>
                    <option>Kewirausahaan</option>
                    <option>Pendidikan Bela Negara</option>
                ...
                <div class="form-group">
                    ...
                    <select type="text" id="fakultas" name="fakultas" class="form-control" style="width: 100%;" value="{{ old('fakultas') }}">
                ...
                <div class="form-group">
                    ...
                    <select type="text" id="jurusan" name="jurusan" class="form-control" style="width: 100%;" value="{{ old('jurusan') }}">

                      <option value="">- Pilih --</option>
                      
                      @foreach ($dbjurusan as $item)
                      <option value="{{$item->id}}" {{$item->id == $item->id ? 'selected' : ''}}>{{$item->nama_jurusan}}</option>    
                      @endforeach
