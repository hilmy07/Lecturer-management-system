                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="nama" name="nama" class="form-control "
                            value="{{ $data_dosenlb->nama }}" style="width: 100%;">
                    ...
                    <div class="form-group">
                        ...
                        <label><input type="checkbox" name="mata_kuliah1" value="-Pendidikan Agama"
                                @if (old('mata_kuliah1', $data_dosenlb->mata_kuliah1)) checked @endif>Pendidikan Agama</label><br>

                        <label><input type="checkbox" name="mata_kuliah2" value="-Bahasa Indonesia"
                                @if (old('mata_kuliah2', $data_dosenlb->mata_kuliah2)) checked @endif>Bahasa indonesia</label><br>

                        <label><input type="checkbox" name="mata_kuliah3" value="-Bahasa Inggris"
                                @if (old('mata_kuliah3', $data_dosenlb->mata_kuliah3)) checked @endif>Bahasa Inggris</label><br>

                        <label><input type="checkbox" name="mata_kuliah4" value="-Kewirausahaan"
                                @if (old('mata_kuliah4', $data_dosenlb->mata_kuliah4)) checked @endif>Kewirausahaan</label><br>

                        <label><input type="checkbox" name="mata_kuliah5" value="-Pendidikan Bela Negara"
                                @if (old('mata_kuliah5', $data_dosenlb->mata_kuliah5)) checked @endif>Pendidikan Bela Negara</label><br>

                        <label><input type="checkbox" name="mata_kuliah6" value="-Pendidikan Pancasila"
                                @if (old('mata_kuliah6', $data_dosenlb->mata_kuliah6)) checked @endif>Pendidikan Pancasila</label><br>

                        <label><input type="checkbox" name="mata_kuliah7" value="-Pendidikan Kewarganegaraan"
                                @if (old('mata_kuliah7', $data_dosenlb->mata_kuliah7)) checked @endif>Kewarganegaraan</label><br>

                        <label><input type="checkbox" name="mata_kuliah8" value="-Kepemimpinan"
                                @if (old('mata_kuliah8', $data_dosenlb->mata_kuliah8)) checked @endif>Kepemimpinan</label><br>
                    </div>

                    <div class="form-group">
                        <label for="">Fakultas</label>
                        <!-- <input name="fakultas" class="form-control" value="{{ old('nama') }}"> -->
                        <select type="text" id="fakultas" name="fakultas" value="{{ $data_dosenlb->fakultas }}"
                    ...
                    <div class="form-group">
                        ...
                        <select type="text" id="jurusan" name="jurusan" value="{{ $data_dosenlb->jurusan }}"
                            class="form-control" style="width: 100%;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="semester" name="semester" class="form-control "
                            value="{{ $data_dosenlb->semester }}" style="width: 100%;">
                    ...
                    <div class="form-group">
                        ...
                        <div id="image-preview" style="margin-top: 10px;">
                            @if ($data_dosenlb->foto_dosen)
                                <img src="{{ asset('foto_dosen/' . $data_dosenlb->foto_dosen) }}" alt="Foto Dosen"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="status" name="status" class="form-control "
                            value="{{ $data_dosenlb->status }}" style="width: 100%;">
