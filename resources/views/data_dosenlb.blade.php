                        ...
                        <tbody>
                            @foreach ($dbdosenlb as $data)
                                <tr>
                                    <td>{{ $data->id }}</td>
                                    <td>{{ $data->nama }}</td>
                                    <td>{{ $data->nama }} {{ $data->gelar_depan }} {{ $data->gelar_belakang }}</td>
                                    <td>{{ $data->nip }}</td>
                                    ...
                                    <td>{{ $data->status }}</td>
                                    <td>
                                        <a href='/edit_dosenlb/{{ $data->id }}' class="btn btn-sm btn-warning">Edit</a>
                                    </td>
                                    <td>
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href='/data_dosenlb/delete/{{ $data->id }}' class="btn btn-outline">Yes</a>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                            </div>
